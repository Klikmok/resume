...
[📄 **Rybakov_Alexey_Backend_Python.pdf**](./Rybakov_Alexey_Backend_Python.pdf)

Нажми на ссылку выше, чтобы открыть или скачать PDF-версию моего резюме.
...
- 🎓 **Образование:** СПбГУ, 1 курс (Системный анализ и управление)
- 💼 **Ищу:** Junior/Middle Python Developer
...
- [REST API для платформы отзывов](https://github.com/Klikmok/api_yamdb)
